# TRIGGER 
-- Asegurar que el insert de transacciones en la tabla 'ventas1' cumplan con la regla de negocio:
-- la cantidad de artículos (QUANTITY) debe ser siempre mayor a cero.alter
-- Previene la inserción de registros inválidos
...
#STORED PROCEDURE
-- Consultas BI rápidas para medios de pago más frecuentes.
...
SELECT CATEGORY, INTERVALOS_PRICE,
